...
@Slf4j
public class DemoDataListenerC implements ReadListener<City> {
     ...
     */
    private DemoDAOC demoDAO;

    public DemoDataListenerC() {
        // 这里是demo，所以随便new一个。实际使用如果到了spring,请使用下面的有参构造函数
        demoDAO = new DemoDAOC();
    }
     ...
     * @param demoDAO
     */
    public DemoDataListenerC(DemoDAOC demoDAO) {
